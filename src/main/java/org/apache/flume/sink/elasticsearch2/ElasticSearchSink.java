...
import org.apache.flume.sink.elasticsearch2.client.ElasticSearchClient;
import org.apache.flume.sink.elasticsearch2.client.ElasticSearchClientFactory;
...
public class ElasticSearchSink extends AbstractSink implements Configurable {
  ...
  public void configure(Context context) {
	if (logger.isInfoEnabled()) {
		logger.info("Configuration: " + context.getParameters());
	}
    if (!isLocal) {
