package com.dynatrace.diagnostics.core.realtime.flume;
...
public class BtExportJSONSerializer implements EventSerializer, Configurable {
	...
	private final static Logger log = LoggerFactory.getLogger(BtExportJSONSerializer.class);
	private final static String CONFIG_CHARSET = "charset";
